...
The complete runnable module lives at [`docs/examples/worldstatestore/`](https://github.com/viamrobotics/visualization/tree/main/docs/examples/worldstatestore). Use [`store.go`](https://github.com/viamrobotics/visualization/blob/main/docs/examples/worldstatestore/store.go) as the reference implementation while reading the rest of this guide.
...
```bash
go get github.com/viamrobotics/visualization/draw
