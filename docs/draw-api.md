...
<a name="DefaultFrameColor"></a>DefaultFrameColor is the fallback color used for frames without an explicit color mapping.
...
<a name="NewArrows"></a>
### func [NewArrows](<https://github.com/viam-labs/motion-tools/blob/main/draw/arrow.go#L50>)
...
### func \(Arrows\) [Draw](<https://github.com/viam-labs/motion-tools/blob/main/draw/arrow.go#L64>)
...
## type [BufferPackedEntry](<https://github.com/viam-labs/motion-tools/blob/main/draw/buffer_packer.go#L13-L15>)

BufferPackedEntry constrains the numeric types that can be packed into a buffer.
...
## type [BufferPacker](<https://github.com/viam-labs/motion-tools/blob/main/draw/buffer_packer.go#L19-L22>)
...
### func [NewBufferPacker](<https://github.com/viam-labs/motion-tools/blob/main/draw/buffer_packer.go#L26>)
...
### func \(\*BufferPacker\[T\]\) [Read](<https://github.com/viam-labs/motion-tools/blob/main/draw/buffer_packer.go#L41>)
...
### func \(\*BufferPacker\[T\]\) [Write](<https://github.com/viam-labs/motion-tools/blob/main/draw/buffer_packer.go#L34>)
...
### func [NewColorChooser](<https://github.com/viam-labs/motion-tools/blob/main/draw/color_chooser.go#L95>)

```go
func NewColorChooser(colors []Color) ColorChooser
```

NewColorChooser creates a ColorChooser from the given colors. If colors is empty, it falls back to all standard web color names from golang.org/x/image/colornames.
...
## type [DrawArrowsOption](<https://github.com/viam-labs/motion-tools/blob/main/draw/arrow.go#L31>)

DrawArrowsOption configures how arrows are drawn \(colors, palette, etc.\).
...
### func [WithArrowColorPalette](<https://github.com/viam-labs/motion-tools/blob/main/draw/arrow.go#L44>)
...
### func [WithPerArrowColors](<https://github.com/viam-labs/motion-tools/blob/main/draw/arrow.go#L39>)
...
### func [WithSingleArrowColor](<https://github.com/viam-labs/motion-tools/blob/main/draw/arrow.go#L34>)
...
### func [WithFrameSystemColor](<https://github.com/viam-labs/motion-tools/blob/main/draw/frame_system.go#L46>)
...
### func [WithFrameSystemColors](<https://github.com/viam-labs/motion-tools/blob/main/draw/frame_system.go#L39>)
...
## type [DrawFramesOption](<https://github.com/viam-labs/motion-tools/blob/main/draw/frames.go#L27>)
...
### func [WithFramesColors](<https://github.com/viam-labs/motion-tools/blob/main/draw/frames.go#L31>)
...
### func [WithGeometryDownscaling](<https://github.com/viam-labs/motion-tools/blob/main/draw/geometry.go#L57>)

```go
func WithGeometryDownscaling(threshold float64) DrawGeometryOption
```

WithGeometryDownscaling creates a geometry option for point clouds that sets the threshold in millimeters below which points are not rendered from one another.
...
### func [WithDotColorPalette](<https://github.com/viam-labs/motion-tools/blob/main/draw/line.go#L112>)
...
### func [WithLineColorPalette](<https://github.com/viam-labs/motion-tools/blob/main/draw/line.go#L86>)
...
### func [WithPerDotColors](<https://github.com/viam-labs/motion-tools/blob/main/draw/line.go#L104>)
...
### func [WithPerLineColors](<https://github.com/viam-labs/motion-tools/blob/main/draw/line.go#L78>)
...
### func [WithSingleDotColor](<https://github.com/viam-labs/motion-tools/blob/main/draw/line.go#L97>)
...
## type [DrawnFrameSystem](<https://github.com/viam-labs/motion-tools/blob/main/draw/frame_system.go#L13-L17>)

DrawnFrameSystem holds a frame system with per\-frame color assignments, ready to be converted into a flat slice of protobuf transforms.
...
### func [NewDrawnFrameSystem](<https://github.com/viam-labs/motion-tools/blob/main/draw/frame_system.go#L53>)
...
### func \(\*DrawnFrameSystem\) [ToTransforms](<https://github.com/viam-labs/motion-tools/blob/main/draw/frame_system.go#L65>)
...
## type [DrawnFrames](<https://github.com/viam-labs/motion-tools/blob/main/draw/frames.go#L17-L20>)
...
### func [NewDrawnFrames](<https://github.com/viam-labs/motion-tools/blob/main/draw/frames.go#L39>)
...
### func \(\*DrawnFrames\) [ToTransforms](<https://github.com/viam-labs/motion-tools/blob/main/draw/frames.go#L52>)
...
### func [NewDrawnGeometry](<https://github.com/viam-labs/motion-tools/blob/main/draw/geometry.go#L64>)
...
### func \(\*DrawnGeometry\) [Draw](<https://github.com/viam-labs/motion-tools/blob/main/draw/geometry.go#L106>)
...
<a name="NewLine"></a>
### func [NewLine](<https://github.com/viam-labs/motion-tools/blob/main/draw/line.go#L126>)
...
<a name="Line.Draw"></a>
### func \(Line\) [Draw](<https://github.com/viam-labs/motion-tools/blob/main/draw/line.go#L162>)
...
### func [NewMetadata](<https://github.com/viam-labs/motion-tools/blob/main/draw/drawing.go#L283>)
...
### func [StructToMetadata](<https://github.com/viam-labs/motion-tools/blob/main/draw/transform.go#L49>)

```go
func StructToMetadata(structPb *structpb.Struct) (Metadata, error)
```

StructToMetadata converts a Protocol Buffer structpb.Struct \(as stored in transforms\) back into drawing Metadata. Colors are decoded from base64\-encoded strings.

<a name="Metadata.SetColors"></a>
### func \(\*Metadata\) [SetColors](<https://github.com/viam-labs/motion-tools/blob/main/draw/drawing.go#L258>)

```go
func (metadata *Metadata) SetColors(colors []Color)
```

SetColors replaces the metadata's color list with the provided colors.

<a name="Metadata.ToProto"></a>
### func \(Metadata\) [ToProto](<https://github.com/viam-labs/motion-tools/blob/main/draw/drawing.go#L293>)
...
### func \(\*Snapshot\) [DrawFrame](<https://github.com/viam-labs/motion-tools/blob/main/draw/snapshot.go#L178-L184>)
