<script lang="ts">
	...
	import TreeContainer from '$lib/components/overlay2/left-pane/TreeContainer.svelte'
	import Details from '$lib/components/overlay2/Details.svelte'
	import SceneProviders from './SceneProviders.svelte'
	import XR from '$lib/components/xr/XR.svelte'
	import { createPartIDContext } from '$lib/hooks/usePartID.svelte'
	import Dashboard from '$lib/components/overlay2/dashboard/Dashboard.svelte'
	...
	import LiveUpdatesBanner from './overlay2/LiveUpdatesBanner.svelte'
	import ArmPositions from './overlay2/widgets/ArmPositions.svelte'
	...
	import Camera from './overlay2/widgets/Camera.svelte'
